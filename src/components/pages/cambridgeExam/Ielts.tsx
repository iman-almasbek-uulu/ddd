...
import bg from "../../../assets/images/ielts.jpg"
    ...
    return (
        <div className={scss.Exam}>
            <div className="container">
                <h1> <span>{t("Что","What")}</span>{t(" такое IELTS?","  is IELTS?")}</h1>
                <div className={scss.image}>
                    <img src={bg} alt="image" />
                </div>
                <h2>{t("Что такое IELTS? Полное введение.","What Is IELTS ? A Complete Introduction")} </h2>
                ...
                <h2>{t("Типы тестов IELTS","Types Of IELTS test")}</h2>
